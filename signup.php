...
<html lang="en">
	...
	<body>
		...
		<!-- Home -->
		<div id="section1" class="container-fluid gradient">
			<!-- 
			...
			<h1>Account Creation:</h1>
				<br /><br /><br /><br />
					<p style="font-size: 36px; color: white;">Existing Users:</p>
		...
		<!-- Bio (The Man) -->
		<div id="section3" class="container-fluid hidden-xs">
		...
		<div id="section5" class="container-fluid">
			<div class="row text-center">
				<div class="col-lg-1 col-lg-offset-4">
					<a href="https://www.facebook.com/crookedwardenmusic/" target="_blank">
						<img class="img-responsive text-center socialLogos" src="facebooklogo.png" width="70" height="auto" style="margin: 0 auto;">
					</a>
				</div>	
				<div class="col-lg-1">
					<a href="https://soundcloud.com/crookedwarden" target="_blank">
						<img class="img-responsive text-center socialLogos" src="soundcloudlogo.png" width="70" height="auto" style="margin: 0 auto;">
					</a>	
				</div>
				<div class="col-lg-1">
					<a href="https://www.youtube.com/watch?v=elgjl9RR2nw" target="_blank">
						<img class="img-responsive text-center socialLogos" src="youtubelogo.png" width="70" height="auto" style="margin: 0 auto;">
					</a>	
				</div>
				<div class="col-lg-1">
					<a href="https://crookedwarden.bandcamp.com/" target="_blank">
						<img class="img-responsive text-center socialLogos" src="bandcamplogo.png" width="70" height="auto" style="margin: 0 auto;">
					</a>	
				</div>
			</div>
		</div>
